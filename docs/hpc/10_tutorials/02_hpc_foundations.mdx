...
```mermaid
architecture-beta
    service server(server)[Greene]
    service disk1(disk)[home]
    service disk2(disk)[scratch]
    service disk3(disk)[archive]
    service disk4(disk)[vast]
    service disk5(disk)[research project space]
